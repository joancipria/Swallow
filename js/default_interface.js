...
var correctY = y-144;
document.getElementById('coordenadas').innerHTML = "<b>"+"x: "+x+", y: "+correctY+"</b>";
...
function gui_addArea(id) {
   ...
   document.getElementById("contador").value = contador;
	...
	temp+= '<option value="rect">rectángulo</option>';
	if (document.getElementById('dd_output').value != 'css') {
		temp+= '<option value="circle">círculo</option>';
		temp+= '<option value="poly">polígono</option>';
	}
	temp+= '</select>';
	temp+= '&nbsp&nbspCoord: <input type="text" name="img_coords" class="img_coords" value="">';
	temp+= '&nbsp&nbspHref: <input type="text" name="img_href" class="img_href" value="">';
	temp+= '&nbsp&nbspAlt: <input type="text" name="img_alt" class="img_alt" value="">';
	temp+= '&nbsp&nbspTarget: <select name="img_target" class="img_target">';
	temp+= '<option value=""  >&lt;-&gt;</option>';
	temp+= '<option value="_self"  >Misma Ventana ( _self )</option>';
	temp+= '<option value="_blank" >Nueva Ventana ( _blank )</option>';
	temp+= '<option value="_top"   >Ventana Actual ( _top )</option>';
	temp+= '</select>';
